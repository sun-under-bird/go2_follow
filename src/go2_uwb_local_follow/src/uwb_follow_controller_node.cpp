...
public:
    ...
    tf_listener_(tf_buffer_)
  {
    ...
    config_.max_linear_speed = declare_parameter<double>("max_linear_speed", 0.60);
    config_.max_angular_speed = declare_parameter<double>("max_angular_speed", 0.84);
