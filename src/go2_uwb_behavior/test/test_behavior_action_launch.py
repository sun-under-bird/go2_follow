...
"""验证随机漫游 Action 到达完成与 FOLLOW 服务抢占."""
...
class TestBehaviorAction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.odom_pub = self.node.create_publisher(Odometry, "/odom_leg", 10)
    ...
    def _send_goal(self, seed, timeout_sec=10.0):
    ...
    def test_roam_complete_interface_lifecycle(self):
        """覆盖 STOP 拒绝、到达、取消、超时和 FOLLOW 抢占完整接口链路."""
        ...
        self._set_mode(SetBehavior.Request.FOLLOW)
        self.latest_target = None
