...
static const _LibAoaRobotMsg_type_support_symbol_names_t _LibAoaRobotMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uwb_aoa_pkg, msg, LibAoaRobotMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uwb_aoa_pkg, msg, LibAoaRobotMsg)),
  }
};
...
{
  return &::uwb_aoa_pkg::msg::rosidl_typesupport_cpp::LibAoaRobotMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uwb_aoa_pkg, msg, LibAoaRobotMsg)() {
  return get_message_type_support_handle<uwb_aoa_pkg::msg::LibAoaRobotMsg>();
}
